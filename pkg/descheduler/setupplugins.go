...
func RegisterDefaultPlugins(registry pluginregistry.Registry) {
	...
	pluginregistry.Register(multiobjective.PluginName, multiobjective.New, &multiobjective.MultiObjective{}, &multiobjective.MultiObjectiveArgs{}, multiobjective.ValidateMultiObjectiveArgs, multiobjective.SetDefaults_MultiObjectiveArgs, registry)
}
